...
// import ultroneousImage from "../../assets/images/ultroneous-image.svg";
...
function Footer({ FooterContainerStyle }) {
    return (
        <div
            className={`${FooterContainerStyle ? FooterContainerStyle : null}`}
        >
            ...
            <Row className={[styles.MxNone, styles.FooterContainer]}>
                ...
                xs={12} sm={12} lg={3} xl={2} className={styles.QuickLinks}>
                    ...
                    <p className={styles.SubscribeNewsletter} style={{ marginBottom: "0" }}>
