        ...
        <Row className="mx-0">
          <div className={styles.TechnoContainer}>
            ...
            <div className={styles.TechnologyOverlay}>
              <div class={styles.TechnologyText}>Web App Development</div>
            </div>
          </div>
          <div className={styles.TechnoContainer}>
            <img
            ...
            />
            <div className={styles.TechnologyOverlay}>
              <div class={styles.TechnologyText}>Mobile App Development </div>
            </div>
          </div>
          <div className={styles.TechnoContainer}>
            <img
            ...
            />
            <div className={styles.TechnologyOverlay}>
              <div class={styles.TechnologyText}>UX/ UI Design</div>
            </div>
          </div>
          <div className={styles.TechnoContainer}>
            <img
            ...
            />
            <div className={styles.TechnologyOverlay}>
              <div class={styles.TechnologyText}>Digital Marketing</div>
            </div>
          </div>
          <div className={styles.TechnoContainer}>
            <img
            ...
            />
            <div className={styles.TechnologyOverlay}>
              <div class={styles.TechnologyText}>Cloud & Devops</div>
            </div>
          </div>
        </Row>
      </div>
